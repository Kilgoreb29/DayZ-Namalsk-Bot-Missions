class BotGroupMissionIslandBase: CustomMission
{
	
	void BotGroupMissionIslandBase() {}
	
	
	// Конфиги ботов
	vector BotSpawnPoint = "3936.736328 5.329050 10053.602539";				// задаем точку спавна бота	
	
	protected int m_botAcuracy = 1;											// Настройка меткости бота (чем выше число, тем чаще бот промазывает)
	
	protected int BotSolderCountMin = 1;  										// назначаем минимальное количесство ботов
	protected int BotSolderCountMax = 6;										// назначаем максимальное количесство ботов
	
	protected int botLootCountMin = 1; 											// назначаем минимальное количество лута у бота
	protected int botLootCountMax = 3; 										// назначаем максимальное количество лута у бота
	...
	void AddCeckPoint(SurvivorBotBase m_BotSolder)
	{
		...
		m_BotSolder.AddCheckpoint("3932.921875 5.742457 10023.404297");
		m_BotSolder.AddCheckpoint("3933.057129 5.874578 10000.707031");
		m_BotSolder.AddCheckpoint("3933.327637 5.682340 9978.759766");
		m_BotSolder.AddCheckpoint("3927.908447 11.489089 9965.851563");
		m_BotSolder.AddCheckpoint("3948.897949 10.402216 9951.747070");
		m_BotSolder.AddCheckpoint("3948.310303 9.421651 9958.021484");
		m_BotSolder.AddCheckpoint("3949.775146 8.829606 9972.380859");
		m_BotSolder.AddCheckpoint("3927.908447 11.489089 9965.851563");
        m_BotSolder.AddCheckpoint("3934.532227 5.797904 9980.030273");
		m_BotSolder.AddCheckpoint("3981.785645 4.991525 10002.882813");
		m_BotSolder.AddCheckpoint("3971.387451 5.702500 9991.055664");
		m_BotSolder.AddCheckpoint("3979.588379 5.005242 10010.869141");
		m_BotSolder.AddCheckpoint("3963.453613 5.392500 10036.261719");
		m_BotSolder.AddCheckpoint("3949.251465 5.317728 10043.854492");       
	}
