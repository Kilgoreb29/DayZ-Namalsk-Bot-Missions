class BotGroupMissionAirport: CustomMission
{
	
	void BotGroupMissionAirport() {}
	
	
	// Конфиги ботов
	vector BotSpawnPoint = "6306.775391 20.747456 9498.304688";				// задаем точку спавна бота	
	...
	protected int botLootCountMax = 5; 										// назначаем максимальное количество лута у бота
	...
	void AddCeckPoint(SurvivorBotBase m_BotSolder)
	{
		...
		m_BotSolder.AddCheckpoint("6301.179688 20.879999 9441.568359");
		m_BotSolder.AddCheckpoint("6298.999512 20.892498 9424.602539");
		m_BotSolder.AddCheckpoint("6300.223633 21.535494 9252.154297");
		m_BotSolder.AddCheckpoint("6293.025879 21.802464 9188.072266");        
  		m_BotSolder.AddCheckpoint("6262.632813 21.263172 9178.266602");
		m_BotSolder.AddCheckpoint("6251.722656 21.271677 9183.816406");
    	m_BotSolder.AddCheckpoint("6249.028809 21.032438 9365.773438");
		m_BotSolder.AddCheckpoint("6246.529785 21.732880 9520.773438");
        m_BotSolder.AddCheckpoint("6299.890137 20.769552 9507.317383");
	}
	...
	private void respawnBotUnitC1(SurvivorBotBase m_Bot)
	{
	...
	{  
		...
		{	
			for ( int u = 0; u < players.Count(); u++ )
			{
				...
				{
					spawnBotGroup();
					GetGame().GetCallQueue(CALL_CATEGORY_GAMEPLAY).Remove(TriggerPlayersC1);			
				} 
			}
		}
	} 
	...
	void StartMissionAI()
	{
		...
		if (canUseTrigger)
		{
			GetGame().GetCallQueue(CALL_CATEGORY_GAMEPLAY).CallLater(TriggerPlayersC1, 5000, true);			
		}
		else
		{
			spawnBotGroup();
