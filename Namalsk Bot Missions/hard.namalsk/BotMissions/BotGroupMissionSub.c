class BotGroupMissionSub: CustomMission
{
	
	void BotGroupMissionSub() {}
	
	
	// Конфиги ботов
	vector BotSpawnPoint = "11895.047852 2.520407 12035.324219";				// задаем точку спавна бота	
	...
	void AddCeckPoint(SurvivorBotBase m_BotSolder)
	{
		...
		m_BotSolder.AddCheckpoint("11877.353516 2.970461 11958.317383");
		m_BotSolder.AddCheckpoint("11927.860352 2.012447 11942.272461");
		m_BotSolder.AddCheckpoint("11961.769531 7.849678 12006.717773");
		m_BotSolder.AddCheckpoint("11989.787109 2.906255 12092.523438");
		m_BotSolder.AddCheckpoint("11949.944336 2.213589 12127.888672");
		m_BotSolder.AddCheckpoint("11890.036133 4.259526 12072.495117");
		m_BotSolder.AddCheckpoint("11877.441406 2.439998 11990.116211");    
	}
